...
func NewMail(from, to, subject, body string) *gomail.Message {
...
func FormatMail(user *model.User, cfg *config.Config, params settings.Settings, language *settings.Yaml) string {
