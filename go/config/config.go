...
type Tranche struct {
	...
	Rate int `json:"rate"` // Rate taxable in % in this tranche
}
		...
		TaxList: []Tax{
			{
				...
				Tranches: []Tranche{
					...
					{Min: 181918, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2025,
				Tranches: []Tranche{
					...
					{Min: 180295, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2024,
				Tranches: []Tranche{
					...
					{Min: 177107, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2023,
				Tranches: []Tranche{
					...
					{Min: 168995, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2022,
				Tranches: []Tranche{
					...
					{Min: 160337, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2021,
				Tranches: []Tranche{
					...
					{Min: 158123, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2020,
				Tranches: []Tranche{
					...
					{Min: 157807, Max: math.MaxInt, Rate: 45},
				},
			},
			{
				Year: 2019,
